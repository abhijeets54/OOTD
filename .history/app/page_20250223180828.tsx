...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-br from-[#ffe8f3] to-[#d9f3ff]">
      <div className="container mx-auto px-4 py-12 max-w-3xl relative">
        ...
        >
          ...
          <div className="absolute -inset-8 rounded-3xl overflow-hidden">
            <div className="absolute inset-0 gradient-container">
              <div className="absolute inset-0 bg-gradient-animation" />
            </div>
          </div>

          {/* Content box with glass effect */}
          <div className="relative px-8 py-10 bg-white/80 backdrop-blur-xl rounded-xl shadow-xl">
        ...
        <motion.div
          ...
          className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-sm text-neutral-600 relative z-10"
        >
