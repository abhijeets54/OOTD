      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <StyledFormField label="What's your gender?">
          <StyledSelect
            ...
            onChange={(e) => formData({ ...formData, gender: e.target.value })}
            required
          >
        ...
        <StyledFormField label="Tell us about your religious preferences">
          <StyledSelect
            ...
            onChange={(e) => formData({ ...formData, religion: e.target.value })}
            required
          >
        ...
        <StyledFormField label="What's the occasion?">
          <StyledInput
            ...
            onChange={(e) => formData({ ...formData, occasion: e.target.value })}
            required
          />
        </StyledFormField>
