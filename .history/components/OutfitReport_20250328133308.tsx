...
const FashionNotification = ({ message, onClose }) => (
        ...
        <div className="flex flex-col items-center justify-center space-y-4 relative z-10">
          ...
          <Button 
            ...
            onClick={() => {
              ...
              // Open Grok in a new window with the prompt
              const grokUrl = `https://grok.com/?referrer=website/`;
              ...
              navigator.clipboard.writeText(prompt).then(() => {
                setNotification({
                  show: true,
                  message: "Outfit description copied to clipboard! Paste it into Grok to bring your fashion vision to life."
                });
              });
            }}
          >
            ...
            />
            Generate Outfit Image with Grok
          </Button>
          <p className="text-white/80 text-sm text-center max-w-md">
            Click to open Grok and generate a visual representation of your outfit
          </p>
        </div>
      </Card>
    </div>
